...
public final class TcEntities {
    public static final EntityType<SmartMinecart> SMART_MINECART = FabricEntityTypeBuilder.create(SpawnGroup.MISC, SmartMinecart::new).dimensions(EntityDimensions.fixed(0.98F, 0.7F)).build();
    ...
    public static void register() {
        ...
        FabricDefaultAttributeRegistry.register(SMART_MINECART, SmartMinecart.createCowAttributes());
